    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profilebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Woman.this, ProfileActivity.class);
        ...
        listbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Woman.this, ListActivity.class);
                startActivity(intent);
        ...
        basketbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Woman.this, BasketActivity.class);
                startActivity(intent);
        ...
        mainbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Woman.this, MainActivity.class);
                startActivity(intent);
        ...
        allbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Woman.this, WomanAll.class);
                startActivity(intent);
        ...
        topsbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Woman.this, WomanTops.class);
                startActivity(intent);
        ...
        bottombutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Woman.this, WomanBottoms.class);
                startActivity(intent);
